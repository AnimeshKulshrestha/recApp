...
public class StudyingRVAdapter extends RecyclerView.Adapter<StudyingRVAdapter.viewHolder> {
    Context context;
    ArrayList<CourseModel> arrCourse;
    FirebaseAuth firebaseAuth;


    public StudyingRVAdapter(Context context, ArrayList<CourseModel> arrCourse) {
    ...
    @NonNull
    @Override
    public StudyingRVAdapter.viewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull StudyingRVAdapter.viewHolder holder, int position) {
        ...
        holder.courseBase.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra("c_state","Studies");
                intent.putExtra("coursename",courseModel.getCourse());
                intent.putExtra("User_id",courseModel.getInstructor().getUserId());
